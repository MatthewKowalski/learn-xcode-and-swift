...
//            }
    ...
    // *** "lazy" keyword ***  -  It only gets loaded up with a value at the time that it's needed (i.e., when we try to use the persistentContainer variable)
        // Only occupying the memory when needed
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        // Name must match the name of the DataModel file
